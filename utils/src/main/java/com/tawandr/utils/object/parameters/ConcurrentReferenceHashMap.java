...
import static com.tawandr.utils.object.ObjectUtil.nullSafeEquals;
import static com.tawandr.utils.object.ObjectUtil.nullSafeHashCode;
...
public class ConcurrentReferenceHashMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
    ...
    protected final class Segment extends ReentrantLock {
                ...
                try {
                    ...
                    for(int i = 0; i < this.references.length; ++i) {
                        ...
                        for(; reference != null; reference = reference.getNext()) {
                            if (!((Set)toPurge).contains(reference)) {
        ...
        private Reference<K, V> findInChain(Reference<K, V> reference, Object key, int hash) {
            for(Reference currRef = reference; currRef != null; currRef = currRef.getNext()) {
